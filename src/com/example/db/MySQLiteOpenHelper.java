...
public class MySQLiteOpenHelper extends SQLiteOpenHelper{
	...
	public void edit(String id,double hi){
		...
		String sql = "update " + constant.TABLE_NAME + " set "
				+ constant.Treehigh + "="+ setFormat(hi)+ " where "+constant.ID+"="+id_num;
		mDatabase.execSQL(sql);
	...
	private double setFormat(double paramDouble)
    {
      return (double)new BigDecimal(paramDouble).setScale(2, 4).doubleValue();
    }
}
